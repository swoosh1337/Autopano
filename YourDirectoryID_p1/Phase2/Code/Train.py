...
def GenerateBatch(BasePath: str, train_images: List, labels: Dict, MiniBatchSize: int, set: str = "Train"):
    ...
    while img_idx < MiniBatchSize:
        ...
        print(random_orig_name)
        orig_img_path = os.path.join(BasePath, f"{set}/Orig", random_orig_name+".jpg")
        warped_img_path = os.path.join(BasePath, f"{set}/Warped", random_orig_name+".jpg")
